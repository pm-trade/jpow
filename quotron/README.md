...
|---|---|---|---|
| `claude30` | AI-infra stock quotes, news, social, sentiment | `docs/data.json`, `docs/history.json` | Shoal |
...
us the sources that did work. `claude30` is skipped outright when Shoal
isn't reachable.
